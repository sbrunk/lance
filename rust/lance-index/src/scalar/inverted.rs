...
/// The `combined_fields` pruning counters, candidates and reads alike, for tests
/// and benches. Never reachable on a normal build; see the `test-scan-stats`
/// feature.
#[cfg(any(test, feature = "test-scan-stats"))]
pub use combined::{CombinedScanStats, combined_fields_search_with_stats};
pub use compound::{
